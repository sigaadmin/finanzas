...
class DeleteProposalFuelNeed
{
    public function handle(OwnRevenueProposal $proposal, OwnRevenueProposalFuelNeed $need, User $user): void
    {
        ...
        DB::transaction(function () use ($proposal, $need, $user): void {
            ...
            $lockedNeed = OwnRevenueProposalFuelNeed::query()->lockForUpdate()->findOrFail($need->id);
