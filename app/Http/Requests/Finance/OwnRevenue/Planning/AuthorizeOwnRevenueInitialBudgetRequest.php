...
class AuthorizeOwnRevenueInitialBudgetRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $budget instanceof OwnRevenueBudget
            ...
            && $this->user()?->can('authorizeInitialBudget', $budget) === true;
    }
    ...
    {
        return [
            'authorization_fingerprint' => ['required', 'string', 'size:64', 'regex:/^[a-f0-9]{64}$/'],
        ];
    }
}
